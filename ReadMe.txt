...
To aid with input validation I created a function that would only work if the user inputed one letter.

Created a property class to protect(encapsulate) the paragraph
